...
public class FilterImageActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tv_title = findViewById(R.id.camerasdk_actionbar_title);
    ...
    private void initView() {
        ...
        tab_effect = findViewById(R.id.txt_effect);
        tab_sticker = findViewById(R.id.txt_sticker);
        txt_cropper = findViewById(R.id.txt_cropper);
        txt_enhance = findViewById(R.id.txt_enhance);
        txt_graffiti = findViewById(R.id.txt_graffiti);

        btn_done = findViewById(R.id.camerasdk_title_txv_right_text);
        btn_done.setText("完成");

...
import com.jihf.imagefilterdemo.camerasdk.example.adapter.ImageGridAdapter;
import com.jihf.imagefilterdemo.camerasdk.example.model.ImageInfo;
...
public class ResultActivity extends Activity {
	...
	public void openCameraSDKImagePreview(Activity activity, String path, int position) {
		...
		intent.setClassName(activity.getApplication(), "com.jihf.camerasdk.PreviewActivity");
		ArrayList<String> list=new ArrayList<String>();
		list.add(path);
	...
	public void openCameraSDKPhotoPick(Activity activity, ArrayList<String> list) {
		Intent intent = new Intent();
		intent.setClassName(activity.getApplication(), "com.jihf.camerasdk.PhotoPickActivity");
		Bundle b=new Bundle();
